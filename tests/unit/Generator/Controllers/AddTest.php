...
class AddTest extends TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->provider->getClassName(Argument::type('string'))->willReturn('Dummy\\Controller\\AddUserAction');
    }

    public function testGenerate()
    {
        $generator = new Add($this->provider->reveal());

        $body = $generator->generate();

        try {
            CodeLoader::loadCode($body, 'AddUserAction.php');
            ...
            $resp = $addAction->process($request, $delegator->reveal());
